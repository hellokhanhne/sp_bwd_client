    ...
    switch (type) {
      case 'drawtext':
        return (
          <BlockTextEdit
            name={name}
            onKeepRatioChange={handleKeepRatioChange}
            onFontTypeChange={handleFontTypeChange}
            onFontChange={handleFontChange}
            onTextChange={handleTextChange}
            onAlignChange={handleAlignChange}
            onColorChange={(color: string) => handleColorChange(color, 'text')}
          />
        );
      case 'image':
        return null;
      default:
        return (
          <BlockItemEdit
            ...
            onColorChange={(color: string) => handleColorChange(color, 'block')}
          />
        );
    }
  };
