...
const BlockEditText: FC<BlockTextEditProps> = ({
  onColorChange,
  onAlignChange,
  onTextChange,
  onFontChange,
  ...
  return (
    <Container>
      ...
      <Line
        onClick={() => changeActiveElement(1)}
        text='Text alignment'
        active={activeElements[1]}
      />
      <Wrapper active={activeElements[1]}>
        <AlignButtons>
          <AlignButton
            onClick={() => onAlignChange('flex-start')}
            square
            name='align-left'
            size={26}
            color='#fff'
          ...
          />
          <AlignButton
            onClick={() => onAlignChange('flex-end')}
            square
            name='align-right'
            size={26}
            color='#fff'
      ...
      <Line
        onClick={() => changeActiveElement(2)}
        text='Font settings'
        active={activeElements[2]}
      />
